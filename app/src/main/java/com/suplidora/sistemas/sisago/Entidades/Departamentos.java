...
public class Departamentos {
   ...
   /* public DptpMuniBarrio(String Codigo_Departamento, String Nombre_Departamento){
        this.Codigo_Departamento = Codigo_Departamento;
        this.Nombre_Departamento = Nombre_Departamento;
    }

    public DptpMuniBarrio(String Nombre_Departamento,String Codigo_Municipio, String Nombre_Municipio){
        this.Nombre_Departamento = Nombre_Departamento;
