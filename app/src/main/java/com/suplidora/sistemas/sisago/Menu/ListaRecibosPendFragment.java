        ...
        protected Void doInBackground(Void... params) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    guardadoOK = false;
                    new Funciones().SendMail("Ha ocurrido un error al actualizar el Recibo. Excepcion controlada", variables_publicas.info + ex.getMessage(), "sisago@suplidora.com.ni", variables_publicas.correosErrores);
                    if(getActivity()==null) return null;
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                ...
                new Funciones().SendMail("Ha ocurrido un error al actualizar el Recibo. Respuesta nula GET", variables_publicas.info + urlStr, "sisago@suplidora.com.ni", variables_publicas.correosErrores);
                if(getActivity()==null) return null;
                getActivity().runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
