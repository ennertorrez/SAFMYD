...
public class ListaVentasHistClientes extends Activity {
    ...
    private void GetVentasService()  {
        ...
        try {
            ...
            if (jsonStr == null) {
                new Funciones().SendMail("Ha ocurrido un error al obtener lista de ventas del cliente,Respuesta nula GET", variables_publicas.info+urlString, "sisago@suplidora.com.ni", variables_publicas.correosErrores);
            } else {
            ...
            new Funciones().SendMail("Ha ocurrido un error al obtener lista de ventas del cliente,Excepcion controlada", variables_publicas.info+ex.getMessage(), "sisago@suplidora.com.ni", variables_publicas.correosErrores);
