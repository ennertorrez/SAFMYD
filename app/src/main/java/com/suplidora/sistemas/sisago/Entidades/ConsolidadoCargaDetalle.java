...
public class ConsolidadoCargaDetalle {
    ...
    public ConsolidadoCargaDetalle(String idVehiculo, String factura, String item, String item_Descripcion, String cantidad, String precio, String subtotal, String iva, String descuento) {
