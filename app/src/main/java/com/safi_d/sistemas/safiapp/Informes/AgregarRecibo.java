...
import com.safi_d.sistemas.safiapp.Auxiliar.SpinnerDialog;
...
import com.safi_d.sistemas.safiapp.Entidades.InformeDetalle;
...
public class AgregarRecibo extends Activity {
    ...
    private boolean GuardarDetalleInforme() {
        ...
        for (HashMap<String, String> item : listaRecibos) {
            ...
            informedetalle.setUsuario("SAFIAPP");
   ...
   private void requestReadPhoneStatePermission() {
    ...
    private void obtenerIdRecibo() {
        ...
        try {
            ...
            if (jsonStr == null) {
                new Funciones().SendMail("Ha ocurrido un error al obtener el Nuevo Id del Recibo, Respuesta nula GET", variables_publicas.info + urlString, "dlunasistemas@gmail.com", variables_publicas.correosErrores);
            } else {
            ...
            new Funciones().SendMail("Ha ocurrido un error al obtener el Nuevo Id del Recibo, Excepcion controlada", variables_publicas.info + ex.getMessage(), "dlunasistemas@gmail.com", variables_publicas.correosErrores);
