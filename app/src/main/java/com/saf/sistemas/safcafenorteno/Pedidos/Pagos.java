...
import com.saf.sistemas.safcafenorteno.Entidades.Bancos;
import com.saf.sistemas.safcafenorteno.Entidades.Cliente;
import com.saf.sistemas.safcafenorteno.Entidades.Recibos;
    ...
    protected void printRecibo(String tImpresion) {
        ...
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                vTipo = lista.get(i).get("TipoPago");
                vFecha = lista.get(i).get("Fecha");
                vDoc = lista.get(i).get("NoCheque");
                vBanco = lista.get(i).get("BancoR");
                vVend = lista.get(i).get("IdVendedor");
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                vFacturas = lista.get(i).get("Facturas");
            }
        ...
        btnOKCliente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        ...
                        R.layout.list_cliente, new String[]{variables_publicas.CLIENTES_COLUMN_IdCliente, "Nombre", "CodigoLetra", variables_publicas.CLIENTES_COLUMN_Direccion, "Ciudad"}, new int[]{R.id.IdCliente, R.id.Nombre, R.id.CodLetra,
                        R.id.Direccion, R.id.Ciudad});
...
/*                    String urlOfAppFromPlayStore = "https://play.google.com/store/apps/details?id=com.suplidora.sistemas.sisago&hl=es";
                    ...
                    Document doc2 = Jsoup
                            .connect(
                                    "https://play.google.com/store/apps/details?id=com.saf.sistemas.safcafenorteno&hl=es")
                            .get()
                            ;
