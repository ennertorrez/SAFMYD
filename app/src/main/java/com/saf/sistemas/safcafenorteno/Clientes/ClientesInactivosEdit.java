package com.saf.sistemas.safcafenorteno.Clientes;
...
//import com.saf.sistemas.safcafenorteno.AccesoDatos.PreciosHelper;
import com.saf.sistemas.safcafenorteno.AccesoDatos.VendedoresHelper;
//import com.saf.sistemas.safcafenorteno.AccesoDatos.ZonasHelper;
...
import com.saf.sistemas.safcafenorteno.Auxiliar.SpinnerDialog;
...
*/
            ...
            if (latestVersion != null && !currentVersion.equals(latestVersion)) {
                ...
                builder.setPositiveButton("Actualizar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //Click button action
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.saf.sistemas.safcafenorteno&hl=es")));
                        dialog.dismiss();
                    }
                });
