package com.saf.sistemas.safmyd.Principal;
...
import com.saf.sistemas.safmyd.Menu.ClientesFragment;
import com.saf.sistemas.safmyd.Clientes.ClientesNew;
import com.saf.sistemas.safmyd.Menu.ClientesInactivosFragment;
import com.saf.sistemas.safmyd.Menu.FacturasFragment;
import com.saf.sistemas.safmyd.Menu.HistoricoventasClienteFragment;
import com.saf.sistemas.safmyd.Menu.ListaEfectividadSupervisor;
import com.saf.sistemas.safmyd.Menu.ListaFacturasFragment;
import com.saf.sistemas.safmyd.Menu.ListaPedidosClientesFragment;
import com.saf.sistemas.safmyd.Menu.ListaPedidosFragment;
import com.saf.sistemas.safmyd.Menu.ListaPedidosSupFragment;
import com.saf.sistemas.safmyd.Menu.ListaTotalFacturado;
import com.saf.sistemas.safmyd.Menu.MaestroProductoFragment;
import com.saf.sistemas.safmyd.Menu.PedidosFragment;
import com.saf.sistemas.safmyd.Pedidos.FacturasMoraClienteFragment;
import com.saf.sistemas.safmyd.Pedidos.ImprimirActivity;
import com.saf.sistemas.safmyd.Pedidos.ListaPagosFragment;
import com.saf.sistemas.safmyd.Pedidos.Pagos;
import com.saf.sistemas.safmyd.Pedidos.PedidosCliente;
...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Servidor = variables_publicas.direccionIp.equals("http://cysnicaraguasafmyd.duckdns.org:8086") ? "SERVIDOR: PRODUCCION" : "SERVIDOR: DESARROLLO";
        } catch (Exception ex) {
        ...
        sd = new SincronizarDatos(DbOpenHelper, ClientesH, VendedoresH, PromocionesH,FormaPagoH,ConfigH, ClientesSucH,
                ArticulosH, UsuariosH, PedidoH, PedidoDetalleH,CategoriaH,TPreciosH,RutasH,EscalaPreciosH,FacturasH,FacturasLineasH,RecibosH,FacturasPendientesH,PrecioEspecialH);
        ...
        if (variables_publicas.usuario.getTipo().equalsIgnoreCase("Supervisor")){
            navigationView.getMenu().getItem(5).getSubMenu().getItem(3).setVisible(true); //Reporte de Eficiencia
        }else{
            navigationView.getMenu().getItem(5).getSubMenu().getItem(3).setVisible(false); //Reporte de Eficiencia
        }
...
/*            navigationView.getMenu().getItem(1).getSubMenu().getItem(0).setVisible(true); //Lista Pedidos
        ...
        if (variables_publicas.usuario.getAddCliente().equalsIgnoreCase("1")){
            if (variables_publicas.usuario.getTipo().equalsIgnoreCase("Supervisor")){
                navigationView.getMenu().getItem(3).getSubMenu().getItem(0).setVisible(true); //Lista Clientes
            }else{
