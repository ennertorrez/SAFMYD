...
public class ListaFacturasMoraClientes extends Activity {
    ...
    private void GetFacturasService()  {
        ...
        String urlString = urlGetFacturasClientes  + ClienteId + "/" + variables_publicas.usuario.getEmpresa_ID();
        try {
        ...
        try {
            ...
            if (jsonStr == null) {
                new Funciones().SendMail("Ha ocurrido un error al obtener lista de facturas con saldo y mora del cliente. Respuesta nula GET", variables_publicas.info+urlString, "sisago@suplidora.com.ni", variables_publicas.correosErrores);
            } else {
            ...
            new Funciones().SendMail("Ha ocurrido un error al obtener lista de facturas con saldo y mora del cliente. Excepcion controlada", variables_publicas.info+ex.getMessage(), "sisago@suplidora.com.ni", variables_publicas.correosErrores);
