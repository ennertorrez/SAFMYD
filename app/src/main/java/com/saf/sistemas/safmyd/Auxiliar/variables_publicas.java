...
import com.saf.sistemas.safmyd.Entidades.Configuraciones;
import com.saf.sistemas.safmyd.Entidades.Factura;
import com.saf.sistemas.safmyd.Entidades.Pedido;
import com.saf.sistemas.safmyd.Entidades.Usuario;
...
public class variables_publicas {
    ...
    public static final String direccionIp = "http://192.168.0.7:8086";
    //public static final String direccionIp = "http://cysnicaraguasafmyd.duckdns.org:8086";
    //public static final String direccionIp = "http://26.20.152.133:8086";
    ...
    public static final String DATABASE_NAME = "Safi_MYD.db";
    //Variables TB
    ...
    public static final String CLIENTES_COLUMN_Saldo="Saldo";
    public static final String CLIENTES_COLUMN_NoEnRuta="NoEnRuta";
    public static final String CLIENTES_COLUMN_Lat="Latitud";
    public static final String CLIENTES_COLUMN_Lng="Longitud";
    ...
    public static final String FACTURAS_COLUMN_latitud = "Latitud";
    public static final String FACTURAS_COLUMN_longitud = "Longitud";
    public static final String FACTURAS_COLUMN_direccionGeo = "DireccionGeo";
    ...
    public static final String FACTURAS_LINEAS_COLUMN_tipoPrecio = "TipoPrecio";
    ...
    public static final String RECIBOS_COLUMN_latitud = "Latitud";
    public static final String RECIBOS_COLUMN_longitud = "Longitud";
    public static final String RECIBOS_COLUMN_direccionGeo = "DireccionGeo";
