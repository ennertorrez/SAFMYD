...
public class FacturasLineasHelper {
    ...
    public void GuardarFacturasLineas(String Factura,
        ...
        contentValues.put(variables_publicas.FACTURAS_LINEAS_COLUMN_tipoPrecio, TipoPrecio);
    ...
    public boolean GuardarFacturasLineas(HashMap<String,String> lstArticulos) {
        ...
        contentValues.put(variables_publicas.FACTURAS_LINEAS_COLUMN_tipoPrecio, lstArticulos.get(variables_publicas.FACTURAS_LINEAS_COLUMN_tipoPrecio));
    ...
    public List<HashMap<String, String>> ObtenerFacturasLineas(String NoFactura) {
        ...
        if (c.moveToFirst()) {
            do {
                ...
                detalle.put(variables_publicas.FACTURAS_LINEAS_COLUMN_tipoPrecio, c.getString(c.getColumnIndex(variables_publicas.FACTURAS_LINEAS_COLUMN_tipoPrecio)));
