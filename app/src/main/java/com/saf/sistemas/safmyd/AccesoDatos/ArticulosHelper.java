...
import com.saf.sistemas.safmyd.Entidades.Existencias;
...
public class ArticulosHelper {
    ...
    public Articulo BuscarArticulo(String Codigo) {
        String selectQuery = "select A.*,E."+ variables_publicas.EXISTENCIAS_COLUMN_Existencia +" AS Existencia2 from " + variables_publicas.TABLE_ARTICULOS+" A LEFT JOIN "+ variables_publicas.TABLE_EXISTENCIAS +" E ON A."+ variables_publicas.EXISTENCIAS_COLUMN_Codigo +"=E."+ variables_publicas.ARTICULO_COLUMN_Codigo +" where A." + variables_publicas.ARTICULO_COLUMN_Codigo + " like '%" + Codigo + "' LIMIT 1";
        ...
        if (c.moveToFirst()) {
            do {
                articulo = (new Articulo(c.getString(c.getColumnIndex(variables_publicas.ARTICULO_COLUMN_Codigo)),
                        ...
                        c.getString(c.getColumnIndex("Existencia2")),
    ...
    public ArrayList<HashMap<String, String>> BuscarArticuloCodigo(String Busqueda) {
        Cursor c= database.rawQuery("select A.*,E."+ variables_publicas.EXISTENCIAS_COLUMN_Existencia +" AS Existencia2 from " + variables_publicas.TABLE_ARTICULOS+" A LEFT JOIN "+ variables_publicas.TABLE_EXISTENCIAS +" E ON A."+ variables_publicas.EXISTENCIAS_COLUMN_Codigo +"=E."+ variables_publicas.ARTICULO_COLUMN_Codigo +" where A."+variables_publicas.ARTICULO_COLUMN_Codigo+" like '%"+Busqueda+"%'", null);
        ...
        if(c.moveToFirst()){
            do{
                ...
                articulos.put("Existencia2", c.getString(c.getColumnIndex("Existencia2")));
                lst.add(articulos);
            }while (c.moveToNext());
        }
        return  lst;
