...
/*        final List<com.saf.sistemas.safcafenorteno.Entidades.TipoPrecio> TPrecio;
    ...
    private class ConsultarExistencias extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                CheckConnectivity();
                if (isOnline) {
                    existencia = SincronizarDatos.ConsultarExistencias(PedidosActivity.this,  ArticulosH, articulo.getCodigo());
                }
            } catch (Exception ex) {
