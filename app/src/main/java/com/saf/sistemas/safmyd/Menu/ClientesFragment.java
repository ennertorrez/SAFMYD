...
public class ClientesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
        ...
        cboDiaVisita = (Spinner) myView.findViewById(R.id.cboDiasVisita);
    ...
    private class GetClientes extends AsyncTask<Void, Void, Void> {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < clientes.length(); i++) {
                        ...
                        cliente.put(variables_publicas.CLIENTES_COLUMN_NoEnRuta, c.getString("NoEnRuta"));
                        cliente.put(variables_publicas.CLIENTES_COLUMN_Lat, c.getString("Latitud"));
                        cliente.put(variables_publicas.CLIENTES_COLUMN_Lng, c.getString("Longitud"));
                        ...
                        if (variables_publicas.usuario.getTipo().equals("Supervisor")||variables_publicas.usuario.getTipo().equals("User")) {
                            ...
                            if (client == null) {
                                ...
                                ClienteH.GuardarClientes(c.getString("IdCliente"), c.getString("Nombre"), c.getString("FechaCreacion"),
                                        ...
                                        c.getString("COD_ZONA"), c.getString("COD_SUBZONA"),c.getString("Pais_Id"),c.getString("Pais_Nombre"), c.getString("IdTipoNegocio"),c.getString("TipoNegocio"),c.getString("SaldoActual"),c.getString("NoEnRuta"),c.getString("Latitud"),c.getString("Longitud"),c.getString("Visita"));
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_cliente, new String[]{variables_publicas.CLIENTES_COLUMN_IdCliente,  "Nombre", variables_publicas.CLIENTES_COLUMN_Direccion,"Saldo"}, new int[]{R.id.IdCliente,  R.id.Nombre,
