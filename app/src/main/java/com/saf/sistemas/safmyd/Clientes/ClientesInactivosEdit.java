...
/*    private ZonasHelper ZonasH;
    ...
    private boolean Guardar() {
        ...
        String mensaje = "";
            mensaje = "¿Está seguro que desea activar el Cliente?";
                ...
                .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (GuardarCliente()) {
                            ...
                            SincronizarCiente(ClientesH.ObtenerDatosClientesParcial(cliente.getIdCliente()));
                        } else {
                            DbOpenHelper.database.endTransaction();
                        }
    ...
    private boolean GuardarCliente() {
        ...
        boolean saved = ClientesH.GuardarClientes(cliente.getIdCliente(), cliente.getNombre(),cliente.getFechaCreacion(), cliente.getTelefono(),
                        ...
                        cliente.getFechaUltimaCompra(), cliente.getTipo(),"Detalle", cliente.getDescuento(), cliente.getEmpleado(),"0",variables_publicas.usuario.getEmpresa_ID(), "0","0","11","NICARAGUA",
                        cliente.getIdTipoNegocio(),cliente.getTipoNegocio(),"0",cliente.getIdCliente(),cliente.getLatitud(),cliente.getLongitud(),"NoCompra");
        if (!saved) {
