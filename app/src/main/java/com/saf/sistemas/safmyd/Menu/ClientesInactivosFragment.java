...
import com.saf.sistemas.safmyd.Clientes.ClientesInactivosEdit;
        ...
        try {
            ...
            switch (item.getItemId()) {
                case R.id.itemEditarCliente:{
                    ...
                    String Lat = obj.get("Latitud");
                    String Lng = obj.get("Longitud");
...
/*
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.list_cliente, new String[]{variables_publicas.CLIENTES_COLUMN_IdCliente,  "Nombre", variables_publicas.CLIENTES_COLUMN_Direccion}, new int[]{R.id.IdCliente, R.id.Nombre,
                    R.id.Direccion});
