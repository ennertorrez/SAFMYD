package com.saf.sistemas.safasuncion.Principal;
...
import com.saf.sistemas.safasuncion.Menu.ClientesFragment;
import com.saf.sistemas.safasuncion.Clientes.ClientesNew;
import com.saf.sistemas.safasuncion.Menu.ClientesInactivosFragment;
import com.saf.sistemas.safasuncion.Menu.HistoricoventasClienteFragment;
import com.saf.sistemas.safasuncion.Menu.ListaPedidosClientesFragment;
import com.saf.sistemas.safasuncion.Menu.ListaPedidosFragment;
import com.saf.sistemas.safasuncion.Menu.ListaPedidosSupFragment;
import com.saf.sistemas.safasuncion.Menu.ListaTotalFacturado;
import com.saf.sistemas.safasuncion.Menu.MaestroProductoFragment;
import com.saf.sistemas.safasuncion.Menu.PedidosFragment;
...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sd = new SincronizarDatos(DbOpenHelper, ClientesH, VendedoresH, PromocionesH,FormaPagoH,ConfigH, ClientesSucH,
                ArticulosH, UsuariosH, PedidoH, PedidoDetalleH,CategoriaH,TPreciosH,RutasH,EscalaPreciosH);
        ...
        if (variables_publicas.usuario.getAddCliente().equalsIgnoreCase("1")){
            navigationView.getMenu().getItem(2).getSubMenu().getItem(0).setVisible(false); //Lista Clientes
            navigationView.getMenu().getItem(2).getSubMenu().getItem(1).setVisible(true); //Agregar Clientes
            navigationView.getMenu().getItem(2).getSubMenu().getItem(2).setVisible(false); //Activar Clientes
        }else{
            navigationView.getMenu().getItem(2).getSubMenu().getItem(0).setVisible(false); //Lista Clientes
            navigationView.getMenu().getItem(2).getSubMenu().getItem(1).setVisible(false); //Agregar Clientes
            navigationView.getMenu().getItem(2).getSubMenu().getItem(2).setVisible(false); //Activar Clientes
        }
        if (variables_publicas.usuario.getTipo().equalsIgnoreCase("Cliente")){
            ...
            navigationView.getMenu().getItem(3).setVisible(false); //Menu Reportes
        }else{
            ...
            navigationView.getMenu().getItem(2).setVisible(true); //Menu Clientes
            navigationView.getMenu().getItem(3).setVisible(true); //Menu Reportes
        }
