package com.saf.sistemas.safasuncion.Clientes;
...
//import com.saf.sistemas.safasuncion.AccesoDatos.PreciosHelper;
import com.saf.sistemas.safasuncion.AccesoDatos.VendedoresHelper;
//import com.saf.sistemas.safasuncion.AccesoDatos.ZonasHelper;
...
import com.saf.sistemas.safasuncion.Auxiliar.SpinnerDialog;
                ...
                .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (GuardarCliente()) {
                          ...
                          //  }
                            SincronizarCiente(ClientesH.ObtenerDatosClientesParcial(cliente.getIdCliente(),cliente.getIdCliente()));
                        } else {
                            DbOpenHelper.database.endTransaction();
                        }
...
/*
        boolean saved = ClientesH.GuardarClientes(cliente.getIdCliente(), cliente.getCodCv(), cliente.getNombre(), cliente.getNombreCliente(), cliente.getFechaCreacion(), cliente.getTelefono(),
...
*/
            ...
            if (latestVersion != null && !currentVersion.equals(latestVersion)) {
                ...
                builder.setPositiveButton("Actualizar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //Click button action
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.saf.sistemas.safasuncion&hl=es")));
                        dialog.dismiss();
                    }
                });
